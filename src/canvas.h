...
// seconds (ported from LCD v0.4.7): auto-dismiss after this many seconds; 0 = persistent
// until replaced or explicitly stopped (an overlay ticker otherwise never goes away).
